      ...
      <div>
        <Card>
          <CardBody>
            ...
            <h3>
              Use this service to report the volume (m&#x00B3;) of commercial timber or firewood you
              harvest. Your cutting permit will specify when you need to report. Failure to report
              harvest volumes may affect your eligibility for future licences.
            </h3>
            <br />
            <p>
              Collection of this information is authorized under the authority of section 22(1)(h) and 24(1)(i)
              of the Forest Resources Act (FRA) and section 15(a) & (c)(i) of the Access to Information and
              Protection of Privacy Act and will be used to fulfill reporting obligations under the FRA Act and
              Regulations.{' '}
            </p>
            <br />
            <p>
              ...
              Phone: 867.456.3999 or toll free at 1.800.661.0408 ext. 3999
            </p>
            <h3>To report harvest volumes:</h3>
            <p>
              <strong>
                Press the button below and log in to the reporting system using your email address and<br />
                your password.
              </strong>
            </p>
            <div>
            ...
            <p>
              <br />
              Another way to report is to complete a  <a href={'https://yukon.ca/en/forest-resources-harvest-report'}>harvest report form.</a>
              <br />
            </p>
            <p>
