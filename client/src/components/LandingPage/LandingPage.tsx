          ...
          <CardBody>
            ...
            <p>
              ...
              <a href={'https://yukon.ca/en/doing-business/permits-and-licensing/harvest-timber-or-firewood-sell'}>
                commercial timber or firewood you harvest
              </a>
              . Your cutting permit will specify when you need to report. Failure to report harvest volumes may affect
              your eligibility for future licences.
            </p>
            <br />
            ...
            <ul>
              <li>
                A Government of Yukon service account. If you don’t have an account, you will be able to create one.
            ...
            <div>
              <Button
                ...
                href={'/api/auth/login'}
              >
                Start reporting your timber harvest
              </Button>
            </div>
            <br />
            ...
            <p>
              ...
              <a href={'mailto:forestry@yukon.ca'}>forestry@yukon.ca</a> or phone 867-456-3999, toll free in Yukon
              1-800-661-0408, extension 3999.
            </p>
            <p>
              You can also {'  '}
              <a
              ...
              or the Forest Management Branch at 91807 Alaska Highway, Whitehorse.
            </p>
            <strong>Other ways to report</strong>
            <p>
              If you prefer a printable version of this service, you can download a PDF and send it to Yukon government.
            </p>
            <ol>
              <li>
                Complete a <a href={'https://yukon.ca/en/forest-resources-harvest-report'}>harvest report form</a>.
              </li>
              <li>
                Submit your completed form at your local Compliance Monitoring and Inspections district office or email{' '}
                <a href={'mailto:forestry@yukon.ca'}>forestry@yukon.ca</a>.
              </li>
            </ol>
            ...
            <p>
              ...
              <i>Forest Resources Act</i> and section 15(a) & (c)(i) of the{' '}
              <i>Access to Information and Protection of Privacy Act</i> and will be used to fulfill reporting
              obligations under the <i>Forest Resources Act</i> and Regulations.{' '}
            </p>
            <br />
            <p>
